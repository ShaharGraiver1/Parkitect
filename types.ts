...
export type RootStackParamList = {
    ...
    EditBooking: { tenantId: number, bookingId: number, guestName: string, vehicleNumber: string, startDateTime: Date, endDateTime: Date, parkingNumber: number, parkingId: number};
